...
<!-- Your existing HTML code for the product detail page -->

<!-- Add your product information display here -->
...
<div class="container mt-5">
    <div class="row">
        <div class="col-md-4">
            <img src="./image/shoes.jpg" alt="Product Image" class="img-fluid">
        </div>
        <div class="col-md-6">
          
            <h1>Adidas Girls Shoes</h1>
      <p>
        Shoes by adidas 
        <li>Low-profile design</li>

        <li>Lace-up fastening</li>
        <li>Pull tab for easy entry</li>
